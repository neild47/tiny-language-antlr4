...
public class Function {
    ...
    public TLValue invoke(List<ExpressionContext> params, Map<String, Function> functions, Scope scope) {
        ...
        //visit functions from this scope
        Map<String, Function> innerFunctinos = new HashMap<>();
        SymbolVisitor symbolVisitor = new SymbolVisitor(innerFunctinos);
        symbolVisitor.visit(this.block);
        innerFunctinos.putAll(functions);

        EvalVisitor evalVisitor = new EvalVisitor(scope, innerFunctinos);
